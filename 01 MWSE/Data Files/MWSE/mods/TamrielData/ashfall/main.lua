...
event.register(tes3.event.initialized, function()
	...
	if ashfall then
		...
		ashfall.registerFoods{
			...
			t_ingfood_gorapple_01 = types.food,
			...
			t_ingfood_passionfruit_01 = types.food,
			t_ingfood_plum_01 = types.food,
			t_ingfood_pomegranate_01 = types.food,
