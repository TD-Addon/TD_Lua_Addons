...
event.register(tes3.event.initialized, function()
	...
	if ashfall then
		...
		ashfall.registerActivators{
			...
			t_cyr_flora_treejoshua_01       = types.tree,
			t_cyr_flora_treejoshua_02       = types.tree,
			t_cyr_flora_treejoshua_03       = types.tree,
			t_cyr_flora_treejoshua_04       = types.tree,
			t_cyr_flora_treejoshua_05       = types.tree,
