return {
	...
	["magic.miscDistractCreatureDesc"] = "This effect compels a creature to wander away from their current position while attempting to keep some distance from the caster. The effect's magnitude is the maximum distance that the target can travel and the effect cannot be casted again on the target while it is active. When the effect ends, the target begins to return to their original location.",
	["magic.miscDistractHumanoid"] = "Distract Humanoid",
	["magic.miscDistractHumanoidDesc"] = "This effect compels a humanoid to wander away from their current position while attempting to keep some distance from the caster. The effect's magnitude is the maximum distance that the target can travel and the effect cannot be casted again on the target while it is active. Using this effect can be considered a minor crime and will fail if the target is aware of the caster's presence. When the effect ends, the target begins to return to their original location.",
