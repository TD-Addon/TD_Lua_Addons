return {
	...
	["magic.miscBloodMagic"] = "Blood Magic",
	["magic.miscBloodMagicDesc"] = "This effect allows the caster to draw on their lifeforce to perform magic; the magicka cost of spells is reduced by half, but is also inflicted to the caster as damage.",
	...
	["magic.miscDetectValuablesDesc"] = "The caster of this effect can detect items valued at %s drakes or more; they appear on the map as symbols. The effect's magnitude is the range in feet from the caster that items are detected.",
	...
	["mcm.Stele"] = "Stele - Interoperability Maintenance",
